...
const WASM_PATH_RELEASE_SIZE = "./build/releaseSize.wasm";
...
export async function setup(width, height) {
	...
	memory = new WebAssembly.Memory({
		initial: 65536 // Math.floor(width * height * 4 / 65536) + 1 // 65536
	});
	...
	await loader.instantiate(fetch(WASM_PATH_RELEASE_SIZE), importObj)
